...
const APIService = {
  ...
  fallbackToLocal(responses) {
    ...
    const recommendations = RecommendationEngine.generateRecommendations(scores);

    // Calculate burnout risk locally
    const risk = PredictionEngine.calculateBurnoutRisk(scores.overall);
